...
import { PrepAIChat } from "../components/PrepAIChat";
  ...
  return (
    <div className="px-4 py-6 max-w-6xl mx-auto">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 lg:gap-6">
        <div
          className="rounded-xl border border-border bg-card p-5 hover-elevate transition-all duration-300"
          ...
          <div className="flex items-center justify-between">
            <div className="space-y-2">
              <p className="text-sm text-muted-foreground">
                Goal: {userStats.weeklyGoal} sections this week
              </p>
            ...
            <ProgressCircle
              percent={Math.round(
                (userStats.weeklyCompleted / userStats.weeklyGoal) * 100
              )}
              size={100}
              strokeWidth={8}
            />
        ...
        <div
          className="rounded-xl border border-border bg-card p-5 hover-elevate transition-all duration-300"
          data-testid="card-streaks-stats"
        >
          <div className="flex items-center gap-2 mb-4">
